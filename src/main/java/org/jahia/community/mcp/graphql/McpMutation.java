...
@GraphQLName("McpMutation")
@GraphQLDescription("MCP mutations")
public class McpMutation {

    private static final Logger LOGGER = LoggerFactory.getLogger(McpMutation.class);
